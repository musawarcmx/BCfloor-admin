    ...
    return (
        <div className='w-full flex justify-center items-start pt-[80px] px-[40px] md:px-0'>
            <div className='w-[400px] flex flex-col gap-[25px]'>
                ...
                <Button
                    onClick={handleLogin}
                    className='flex justify-center items-center bg-[#fff] hover:bg-[#4290E9] hover:text-[#fff] border-[1px] border-[#4290E9] text-[#4290E9] rounded-[6px] h-[42px] font-[600] text-[20px]'>Login</Button>
